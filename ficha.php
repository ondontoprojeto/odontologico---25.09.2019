                            ...
                            <tr>
                                ...
                                <td>
                                   ...
                                   <!--<a class="btn btn-danger btn-sm"  style="color:#fff" href="#" onclick="excluir(<?php echo $array['id_pessoa'];?>)" role="button"><i class="fa fa-trash-o" aria-hidden="true"></i></a> -->
                                    ...
                                    <a class="btn btn-primary btn-sm"  style="color:#fff" href="#" onclick="visualizar(<?php echo $array['id_pessoa'];?>)" role="button"><i class="far fa-eye" aria-hidden="true">Visualiza</i></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
